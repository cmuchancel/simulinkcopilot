...
from ir_v2.equation_dict import equation_to_string
from ir_v2.graph_lowering import lower_first_order_system_graph
from ir_v2.graph_validate import validate_graph_dict
from latex_frontend_v2.symbols import DeterministicCompileError, state_name
                    ...
                    if engine_error is not None or eng is None:
                        ...
                        try:
                            ...
                            if stages["simulink_build"]["status"] != "passed":
                                ...
                                failure_stage = failure_stage or "simulink_build"
                                failure_reason = failure_reason or str(exc)
                            elif stages["simulink_simulation"]["status"] != "passed":
