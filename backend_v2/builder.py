"""MATLAB-backed builder for hierarchical backend v2 Simulink model dictionaries."""
...
from backend_v2.simulink_dict import ROOT_SYSTEM, BackendSimulinkModelDict, validate_simulink_model_dict
from simulink_v2.utils import ensure_output_dir, format_position, matlab_param_value, sanitize_block_name
